...
import com.example.tokobuku.ui.home.HomeFragment
import com.example.tokobuku.ui.keranjang.KeranjangFragment
import com.example.tokobuku.ui.profile.ProfileFragment
import com.example.tokobuku.ui.riwayat.RiwayatFragment
...
class HomeActivity : AppCompatActivity() {
    ...
    val fragmentUser: Fragment = ProfileFragment()
    ...
    private fun setOptButtonNav() {
        ...
        fm.beginTransaction().add(R.id.frm_home, fragmentUser).hide(fragmentUser).commit()
